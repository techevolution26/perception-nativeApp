...
export type UserSlim = components["schemas"]["UserSlim"] & { professional_industries: string[]; professional_roles: string[]; primary_professional_role: string | null; primary_professional_industry?: string | null; primary_professional_role_label: string | null; professional_role_labels: string[]; verified_professional_roles: string[]; };
export type UserWithUnread = components["schemas"]["UserWithUnread"] & { verification_status?: string; verification_badge?: string | null; };
