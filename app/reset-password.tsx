        ...
        <View className="gap-4">
          <View>
            ...
            <TextInput
              ...
              secureTextEntry
              autoCapitalize="none"
              className="rounded-control border border-border-hairline bg-surface-sunken px-3.5 py-3 font-sans text-sm text-foreground"
              placeholder="••••••••"
          ...
          <Text className="font-sans text-xs leading-4 text-foreground-subtle">
            Use 8–128 characters with uppercase, lowercase, number, and special
            character.
          </Text>
          {error && (
            <View className="rounded-control bg-danger/10 p-3">
