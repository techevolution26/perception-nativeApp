...
export default function VerifiedBadge({
  ...
  if (compact) {
    ...
    return (
      ...
      >
        ...
        {verified && (
          <View className="absolute -bottom-0.5 -right-1 h-3.5 w-3.5 items-center justify-center rounded-full border border-background bg-background">
            <MaterialCommunityIcons
              name="check-decagram"
              size={12}
              color={visual.color}
  ...
  return (
    ...
    >
      ...
      {roleCode && (
        <Text
          className="ml-1.5 font-sans-medium text-[11px]"
