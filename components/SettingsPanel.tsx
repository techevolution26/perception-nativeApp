    ...
    <View className="px-4 pb-10">
      ...
      >
        ...
        <View className="flex-1">
          <Text className="font-sans-medium text-[15px] text-foreground">Change password</Text>
          <Text className="mt-0.5 font-sans text-xs text-foreground-subtle">Update the password used to sign in</Text>
        </View>
